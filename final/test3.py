    ...
    if time.time() - start_time >= 60:  # Check if 1 minute has passed
        ...
        for symbol in symbols_config:
            ...
            if current_price is None or start_price is None:
                # Handle the case where one of the prices is None
                format_message = {
                    "symbol": symbol_name,
                    "start_price": start_price,
                    "current_price": current_price,
                    "pip_difference": "N/A",  # Can't calculate difference
            ...
            # Append to price array and send Discord message
            price_array_update.append(format_message)
            send_discord_message(format_message)
